...
```
LAYER 1  .github/core/             → company core: coding standards, processes, checklists, rules, patterns
LAYER 2  .github/stack/            → Tech-specific guidelines: .NET, Vue, SQL, Azure, Docker
LAYER 3  .github/skills/           → Agent skills: BMAD, GitHub management, Plane issue tracking, frontend design, Microsoft docs, TDD
LAYER 4  .github/agents/           → Custom agents: architect, code, debug, ask, pm, review, sales
LAYER 5  docs/                     → project context: specs, architecture, memory
```

## Knowledge Base

All rules are stored in `.github/` — Copilot-native, no vendor abstraction layer.
...
Seven specialized agents in `.github/agents/`: architect, code, debug, ask, pm, review, sales.
